...
import {AppMenuItem} from "@prosevo_web_responsive/components/apps_menu_item/apps_menu_item.esm";
import {AppsMenuSearchBar} from "@prosevo_web_responsive/components/menu_searchbar/searchbar.esm";
...
Object.assign(AppsMenu, {
    template: "prosevo_web_responsive.AppsMenu",
    props: {
        slots: {
            type: Object,
            optional: true,
